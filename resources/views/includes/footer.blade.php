                ...
                <div class="col-lg-5">
                    <div class="footer-left">
                        <div class="footer-logo">
                            <a href="#"><img src="{{ asset('frontend/img/logoziya2.png') }}" alt="" /></a>
                        </div>
                        <ul>
                            <li>Address: Ngampel, Gresik</li>
                            <li>Phone: +628 5604476368</li>
                            <li>Email: shofiyah.ziya18@gmail.com</li>
                        </ul>
                        <div class="footer-social">
                            <a href="#"><i class="fa fa-facebook"></i></a>
                            <a href="https://www.instagram.com/ziiyaaa__/"><i class="fa fa-instagram"></i></a>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="copyright-text">
                            ...
                            All rights reserved | Ziyadatus Shofiyah
                        </div>
                    </div>
                </div>
            </div>
